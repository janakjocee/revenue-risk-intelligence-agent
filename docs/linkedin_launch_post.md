...
I built Revenue Risk Intelligence Agent, an AI/data science portfolio project for customer-success teams.

It predicts churn risk, estimates revenue at risk, retrieves account evidence, recommends retention actions, drafts customer-success emails, and presents everything in a Streamlit dashboard.
...
Project launch: Revenue Risk Intelligence Agent

What it does:

- predicts customer churn risk
- estimates revenue at risk
- retrieves synthetic account evidence
- explains risk drivers
- recommends next-best actions
- drafts customer-success emails
- exports account briefs
- supports what-if simulation
- tracks evaluation and observability
